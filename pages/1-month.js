...
function pricing(props) {
    ...
    useEffect(() => {
        ...
        setPrice(10 + 7*parseInt(cnxx ))
        setPackshow("1 Month - Full Pass - "+truecnx +" Connections")
      }, [cnxx])
                        ...
                        <div className="space-y-7">
                            ...
                            <div className=" rounded-md px-3    ">
                                ...
                                <select
                                    ...
                                    <option value="1" >+ 1 Extra Connections - £7
                                    </option>
                                    <option value="2" >+ 2 Extra Connections - £14
                                    </option>
                                    <option value="3" >+ 3 Extra Connections - £21
                                    </option>
