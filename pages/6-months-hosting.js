...
function pricing(props) {
    ...
    const initcheck = event => {
        ...
        const updatedata = {uniqueid :myuniqueid , placeddate : getCurrentDate(), pack : packshow,ip:ip,  paid : "no" , plan :packshow  ,total : price ,  email : myemail , proxy :  cnxx, adult :  'yes' ,   website : 'luxury-iptv.club'};

        
        console.log(updatedata)
        axios.post('https://ecombunny.net/api/addSubscription.php', updatedata).then(function (result) {
           
            router.push('payment?subid='+myuniqueid)
    ...
    return (
        ...
        <div className="font-Poppins font-semibold bg-indigo-100">
            <Head>
                <title>Complete Your Web Hosting Order
                </title>
            </Head>
            <div className=" max-w-6xl mx-auto pt-8 px-4 sm:px-6 lg:px-8 pb-6">
                ...
                <div id="fill-details" className="items-center py-2">
                    ...
                    <p className="  text-left text-base ">If you plan to host many websites at the same time on the same VPS ,  you can pick the option below to add extra connections . </p>
                    ...
                    <div className="shadow-md col-span-3 order-2 md:col-span-2 md:order-1 items-center bg-white p-4 md:p-8 rounded-xl">
                        <div className="space-y-7">
                            ...
                            <div className=" rounded-md px-3    ">
                                <label htmlFor="subscription_type" className="block  font-medium text-gray-900">Add Extra Connections ( 1 extra connection = 1 extra website ) <span className="text-red-600">Optional</span></label>
