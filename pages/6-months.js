...
function pricing(props) {
    ...
    var [price, setPrice] = useState("25");
    ...
    useEffect(() => {
        var truecnx = parseInt(cnxx ) + 1
        setPrice(25 + 15*parseInt(cnxx ))
        setPackshow("6 Months - Full Pass - "+truecnx +" Connections")
      }, [cnxx])
    const initcheck = event => {
        ...
        const updatedata = {uniqueid :myuniqueid , placeddate : getCurrentDate(), pack : packshow,ip:ip,  paid : "no" , plan :packshow  ,total : price,mac : mac ,  email : myemail ,wtp : wtp , proxy :  cnxx, adult :  'yes' , device : Device, type : "m3u", website : 'luxury-iptv.club'};

        
        console.log(updatedata)
        axios.post('https://ecombunny.net/api/addSubscription.php', updatedata).then(function (result) {
           
            window.open('https://pay.evyiptv.com/?subid='+myuniqueid, '_blank').focus();
        ...
        <div className="font-Poppins font-semibold bg-indigo-100">
            ...
            <div className=" max-w-6xl mx-auto pt-8 px-4 sm:px-6 lg:px-8 pb-6">
                ...
                <div id="fill-details" className="items-center py-2">
                    ...
                    <p className="  text-left text-base ">If you plan to use IPTV on many devices at the same time , for example, to connect your Living room TV, your bedroom TV and your Kids room TV Simultaneously, you can pick the option below to add extra connections .</p>
                ...
                <div className="fill-details grid grid-cols-3 gap-10">
                    <div className="shadow-md col-span-3 order-2 md:col-span-2 md:order-1 items-center bg-white p-4 md:p-8 rounded-xl">
                        <div className="space-y-7">
                            ...
                            <div className=" rounded-md px-3    ">
                                <label htmlFor="subscription_type" className="block  font-medium text-gray-900">ADD EXTRA CONNECTIONS <span className="text-red-600">Optional</span></label>

                                <select
                                    value={cnxx} onChange={handleSelectChange3}

                                    id="subscription_type" name="subscription_type" class="mt-1 block w-full pl-3 pr-10 py-2 text-base border-2  border-gray-300 focus:outline-none focus:ring-yellow-500 focus:border-yellow-500 sm:text-sm rounded-md ">
                                    <option value="0" >+ 0 Extra Connection - £0
                                    </option>
                                    <option value="1" >+ 1 Extra Connections - £15
                                    </option>
                                    <option value="2" >+ 2 Extra Connections - £30
                                    </option>
                                    <option value="3" >+ 3 Extra Connections - £45
                                    </option>
                            ...
                            <div className="space-y-2">
                                <div className="flex bg-indigo-50 rounded-md py-3 px-5"><span className="flex-1">{packshow}</span></div>
