...
import wp from './iso.png'
import Image from 'next/image'
import Navv from './hosting-nav'
import security from './speed2.png'
...
const website = () => {
    return (
        <div>
            <Navv />
            <Head >
<title>Website Loading Speed | Luxury Hosting UK</title>
                   </Head>
            <section className="relative flex flex-col items-center justify-center w-full px-6 py-10 bg-white bg-cover  min-w-screen">
                <div className="flex flex-col items-center justify-center mx-auto sm:p-6 xl:p-8 lg:flex-row lg:max-w-6xl lg:p-0">
                    <div className="container relative z-20 flex flex-col w-full px-5 pb-1 pr-12 mb-16 text-2xl text-gray-700 lg:w-1/2 sm:pr-0 md:pr-6 md:pl-0 lg:pl-5 xl:pr-10 sm:items-center lg:items-start lg:mb-0">
                        ...
                        Website Loading Speed crushing your competition!

                        </h1>
                        <p className="relative z-20 block mt-6 text-base text-gray-500 xl:text-xl sm:text-center lg:text-left">The loading speed of your website is one of the key components for a successful online presence! Make no compromises and use Luxury Hosting UK Speed Reaper service which powers every blazingly fast website we host.
            ...
            <section  className="box-border relative block py-10 overflow-hidden leading-6 text-left bg-white">
                <div className="max-w-6xl px-4 px-16 mx-auto leading-6 text-left xl:px-12">
                    <div className="box-border flex flex-col flex-wrap items-start mx-0 text-gray-900">
                        ...
                        <h3 className="relative w-full px-0 pb-2 m-0 font-sans text-4xl font-bold text-center xl:flex-grow-0  xl:flex-shrink-0 md:flex-grow-0 md:flex-shrink-0 lg:flex-grow-0 lg:flex-shrink-0">Benefits of having Fast Loading Website
                    ...
                    <div className="grid grid-cols-3 gap-5 text-gray-900 md:grid-cols-6">
                        <div className="relative w-full col-span-3 px-4 leading-6 text-left  border-b-2 border-black ">
                            <div className="box-border flex items-center justify-start pt-12 text-gray-900">
                                ...
                                <div className="pl-2 leading-6 ">
                                    ...
                                    <div className="box-border text-base leading-normal text-gray-700">It is known that Google uses a complex user experience algorithm, part of which is the website loading speed!
                        ...
                        <div className="relative w-full col-span-3 px-4 leading-6 text-left  border-b-2 border-black  ">
                            <div className="box-border flex items-center justify-start pt-12 text-gray-900">
                                <div className="w-full leading-6 text-left">
                                    ...
                                    Fast Website means happier visitors browsing your website! This increases conversions by more than 15%!
                        ...
                        <div className="relative w-full col-span-3 px-4 leading-6 text-left  border-b-2 border-black ">
                            <div className="box-border flex items-center justify-start pt-12 text-gray-900">
                                ...
                                <div className="w-full leading-6 text-left">
                                    <div className="box-border pb-1 text-xl font-medium text-gray-900">More time spent



                                    </div>
                                    <div className="box-border text-base leading-normal text-gray-700">
                                    The loading speed of your websites also increases the time spent by its visitors on each and every page!
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div className="relative w-full col-span-3 px-4 leading-6 text-left  border-b-2 border-black ">
                            <div className="box-border flex items-center justify-start pt-12 text-gray-900">
                                <div className="w-full leading-6 text-left">
                                    ...
                                    <div className="box-border text-base leading-normal text-gray-700">
                                    The user Bounce Rate is significantly reduced when your website loads fast, translating in more page views!
                        ...
                        <div className="relative w-full col-span-3 px-4 leading-6 text-left  border-b-2 border-black ">
                            <div className="box-border flex items-center justify-start pt-12 text-gray-900">
                                <div className="w-full leading-6 text-left">
                                    ...
                                    <div className="box-border text-base leading-normal text-gray-700">
                                    As final touch to every Website Speed oriented solution, CloudFlare offers free CDN service that will boost the static content delivery of a website!
                        ...
                        <div className="relative w-full col-span-3 px-4 leading-6 text-left  border-b-2 border-black ">
                            <div className="box-border flex items-center justify-start pt-12 text-gray-900">
                                <div className="w-full leading-6 text-left">
                                    ...
                                    <div className="box-border text-base leading-normal text-gray-700">
                                    Brotli is complex compression algorithm for lossless compression of data. It reduces page size as well as the loading time!
                    ...
                    <div className="flex flex-wrap items-center sm:-mx-3">
                        <div className="w-full md:w-1/2 md:px-3">
                            <div className="w-full pb-6 space-y-6 sm:max-w-md lg:max-w-lg md:space-y-4 lg:space-y-8 xl:space-y-9 sm:pr-5 lg:pr-0 md:pb-0">
                                ...
                                <br/>
<br/>
The most modern Solid-State Drives power the storage of all our servers for optimal read/write speeds. This enhances the loading speed of the websites by reducing the time needed for read/write operations on the files of the websites. Furthermore, the Database queries are processed faster, which reduces the time a website waits for the result!
