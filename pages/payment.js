...
function pricing(props) {
    ...
    useEffect(() => {
      if ( uniqueid != null){
          (async () => {
              let checkresult =  axios.post(API_URL+'subuniqueid2.php',{uniqueid : uniqueid}).then(response => response.data);   
    ...
    useEffect(() => {
      ...
      var realtoken = "AY6maEX10t-5kFZ4TfCdmgHsDVdLSSH_3Hy62r6YKUkPZG9dYYh_ogDk9N9e2zNdPPMNXTw-ONx3j6DP"
    return (
