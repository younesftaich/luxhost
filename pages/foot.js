        ...
        <img src="https://ecombunny.net/assets/evy.png" className="md:max-h-10 max-h-7" />
          ...
          <ul className="p-0 m-0 text-base leading-tight list-none">
            <li className="box-border py-2 text-sm font-normal text-left text-gray-500 md:text-base md:mb-1">
              <a href="#_" className="text-base leading-tight no-underline bg-transparent cursor-pointer hover:text-gray-400">Home</a>
            </li>
            <li className="box-border py-2 text-sm font-normal text-left text-gray-500 md:text-base md:mb-1">
              <a href="#_" className="text-base leading-tight no-underline bg-transparent cursor-pointer hover:text-gray-400">Downloads</a>
            </li>
            <li className="box-border py-2 text-sm font-normal text-left text-gray-500 md:text-base md:mb-1">
              <a href="#_" className="text-base leading-tight no-underline bg-transparent cursor-pointer hover:text-gray-400">Web App</a>
            </li>
            <li className="box-border py-2 text-sm font-normal text-left text-gray-500 md:text-base md:mb-1">
              <a href="#_" className="text-base leading-tight no-underline bg-transparent cursor-pointer hover:text-gray-400">Changelog</a>
            </li>
            <li className="box-border py-2 text-sm font-normal text-left text-gray-500 md:text-base md:mb-1">
              <a href="#_" className="text-base leading-tight no-underline bg-transparent cursor-pointer hover:text-gray-400">Integrations</a>
            </li>
            <li className="box-border py-2 text-sm font-normal text-left text-gray-500 md:text-base md:mb-1">
              <a href="#_" className="text-base leading-tight no-underline bg-transparent cursor-pointer hover:text-gray-400">Templates</a>
            </li>
          </ul>
        </div>
      </div>
    ...
    <div className="flex flex-col items-center justify-between w-full py-12 text-xs leading-none text-gray-500 border-t border-gray-800 lg:flex-row">
      ...
      <ul className="flex my-6 text-sm text-gray-500 list-none lg:flex-grow-0 lg:flex-shrink-0 lg:my-0">
        <li className="box-border block font-semibold text-left">
          <a href="#_" className="pr-5 mr-5 text-gray-500 no-underline bg-transparent border-r border-gray-700 cursor-pointer">Terms of service</a>
        </li>
        <li className="box-border block font-semibold text-left">
          <a href="#_" className="pr-5 mr-5 text-gray-500 no-underline bg-transparent border-r border-gray-700 cursor-pointer">Privacy policy</a>
        </li>
        <li className="box-border block font-semibold text-left">
          <a href="#_" className="pr-5 mr-5 text-gray-500 no-underline bg-transparent border-r border-gray-700 cursor-pointer">Licenses</a>
        </li>
        <li className="box-border block font-semibold text-left">
          <a href="#_" className="text-gray-500 no-underline bg-transparent cursor-pointer">Sitemap</a>
        </li>
      </ul>
