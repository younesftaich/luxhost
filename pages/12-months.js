...
function pricing(props) {
    ...
    useEffect(() => {
        ...
        setPrice(40 + 30*parseInt(cnxx ))
        setPackshow("12 Months - Full Pass - "+truecnx +" Connections")
      }, [cnxx])
                        ...
                        <div className="space-y-7">
                            ...
                            <div className=" rounded-md px-3    ">
                                ...
                                <select
                                    ...
                                    <option value="1" >+ 1 Extra Connections - £30
                                    </option>
                                    <option value="2" >+ 2 Extra Connections - £60
                                    </option>
                                    <option value="3" >+ 3 Extra Connections - £90
                                    </option>
